...
copy_bom -f ../pytorch_predict.yaml --root image --include-dir /opt/occlum/etc/template
...
echo -e "${BLUE}occlum run /bin/python3 predict.py${NC}"
occlum run /bin/python3 predict.py
